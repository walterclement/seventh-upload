		...
		<form:form id="registerForm"  method="post"
			...
			<tr>
				...
				<tr>
					...
					<td><form:input path="name" value="${prdList.name}" readonly="true" /></td>
				</tr>
				<tr>
					<td><label>product description</label></td>
					<td><form:input path="description" value="${prdList.description}" readonly="true" /></td>
				</tr>
				<tr>
					<td><label>product price</label></td>
					<td><form:input path="price" value="${prdList.price}" readonly="true" /></td>
				</tr>
